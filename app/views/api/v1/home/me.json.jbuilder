...
json.data do |json|
  ...
  json.hasOwnStories @profile_data['hasOwnStories']
  json.hasOwnIllustrations @profile_data['hasOwnIllustrations']
  json.storiesDownloadLimitReached current_user && current_user.story_download_count >= 30 ? true :false
  json.consentFlag current_user && current_user.consent_flag ? true : false
  json.imagesDownloadLimitReached current_user.present? && current_user.illustration_download_limit_reached?
