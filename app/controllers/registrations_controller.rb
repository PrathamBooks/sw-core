class RegistrationsController < Devise::RegistrationsController  
  ...
  def sign_up_organization_params
    params.require(:user).permit(:first_name, :last_name, :email, :password, :password_confirmation, :city, :consent_flag, organization_attributes:[:organization_name,:city, :country, :number_of_classrooms, :children_impacted, :status])
  end
  
  def sign_up_params
    params.require(:user).permit(:first_name, :last_name, :email, :password, :password_confirmation, :consent_flag)
  end
