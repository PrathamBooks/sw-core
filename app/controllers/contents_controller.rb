class ContentsController < ApplicationController
  ...
  def thank_you
    ...
    @story = Story.find_by(hash_id: params[:id])
    @story.increment!(:reads) if @story.present?
    StoryRead.save_story_read(nil, @story, :download) if @story.present?
  end
