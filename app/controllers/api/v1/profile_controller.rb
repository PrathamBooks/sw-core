class Api::V1::ProfileController < Api::V1::ApplicationController
  ...
  def user_details
    ...
    if(!illustrator.nil?)
      illus_params = ActionController::Parameters.new({search: {illustrator_slugs: "#{@user.slug}", image_mode: "false"}, no_gif_images: !current_user.try(:allow_gif_images), page: page, per_page: per_page})
