 ...
 */
 ! function(e) {
    ...
    t = ".rating", a = 0, n = 5, r = .5, i = function(t, a) {
        ...
        generateRating: function() {
            var e = this,
                t = e.renderClear(),
                a = e.renderCaption(),
                n = e.rtl ? "rating-container-rtl" : "rating-container",
                r = e.getStars();
            n += e.glyphicon ? ("" === e.symbol ? " rating-gly-star" : " rating-gly") + e.ratingClass : i(e.ratingClass) ? " rating-uni" : " " + e.ratingClass, e.$rating.attr("class", n), e.$rating.attr("data-content", r), e.$stars.attr("data-content", r), n = e.rtl ? "star-rating-rtl" : "star-rating", e.$container.attr("class", n + " rating-" + e.size), e.$container.removeClass("rating-active rating-disabled"), e.$container.addClass(e.inactive ? "rating-disabled" : "rating-active"), i(e.$caption) && (e.rtl ? e.$container.prepend(a) : e.$container.append(a)), i(e.$clear) && (e.rtl ? e.$container.append(t) : e.$container.prepend(t)), i(e.containerClass) || l(e.$container, e.containerClass)
        },
        getStars: function() {
            var e, t = this,
                a = t.stars,
        ...
        renderClear: function() {
            var e, t = this;
            return t.showClear ? (e = t.getClearClass(), i(t.$clearElement) ? '<div class="' + e + '" title="' + t.clearButtonTitle + '">' + t.clearButton + "</div>" : (l(t.$clearElement, e), t.$clearElement.attr({
    ...
    }, e.fn.rating.Constructor = g, e(document).ready(function() {
