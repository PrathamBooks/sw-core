function IllustrationDrawerService(){
  ...
  var set_card_call = function(){
    $('.set-card').on('click', function(){
      var illustration_id = $(this).data('illustrationId');
      var ajaxData = { 'illustration_id': illustration_id };
      var url = "/v0/editor/story/" +  story_id() + "/storycard_image_upload";
      $.ajax({
	url: url,
	type: 'put',
	data: ajaxData,
  ...
  var allowGifImages = function(){
    return $('#right_side_editor .front-cover-page')[0] || ($('#storycard_form')[0] && $("#storycard_form")[0].innerHTML) ? false : true
  }
  ...
  var getSearchFilters = function(){
    ...
    var data = {
      ...
      allow_gif_images: allowGifImages(),
      page: 1,
      per_page: perPage,
      story_id: story_id()
    }
