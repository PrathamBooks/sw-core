...
describe Story, :type => :model do
  ...
  describe "attributions" do
    ...
    it "should insert appropriate number of back inner cover pages based on the illustration attributes" do
      ...
      expect(@original_story.pages[-3].type).to eql(StoryPage.name)
    ...
    it "should consider original story attributions when inserting back inner cover pages" do
      ...
      expect(@parent_relevelled_story.pages[-4].type).to eql(StoryPage.name)
      expect(@parent_relevelled_story.pages[-3].type).to eql(StoryPage.name)
    ...
    it "should consider original and parent story attributions when inserting back inner cover pages" do
      ...
      expect(@child_relevelled_story.pages[-4].type).to eql(StoryPage.name)
      expect(@child_relevelled_story.pages[-3].type).to eql(StoryPage.name)
  ...
  describe "License" do
    ...
    it "should get unique list of all illustration license types" do
      ...
      expect(license_types).to match_array([])
    end
  end
