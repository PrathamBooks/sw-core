...
#SHOW
  context "SHOW/GET Illustrations Details" do
    it "should show the illustration details" do
      ...
      expect(JSON.parse(response.body)['data']['publisher']['logo']).to start_with('/public/spec/test_files/organizations/')
      ...
      expect(JSON.parse(response.body)['data']['imageUrls'][0]['sizes'][0]['url']).to start_with('/public/spec/test_files/illustrations/')
      ...
      expect(JSON.parse(response.body)['data']['similarillustrations'][0]['imageUrls']['sizes'][0]['url']).to start_with('/public/spec/test_files/illustrations/')
