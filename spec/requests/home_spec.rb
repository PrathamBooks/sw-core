...
RSpec.describe "Api::V1::Home::Requests", :type => :request do
  ...
  context "GET home page details" do
    ...
    it "should show home page editorsPick details" do
      ...
      expect(JSON.parse(response.body)['data']['editorsPick']['results'][0].keys).to contain_exactly("id", "title", "language", "level", "slug", "recommended",  "editorsPick", "coverImage", "authors", "illustrators", "likesCount", "publisher", "readsCount", "description", "contest", "availableForOfflineMode", "storyDownloaded", "isAudio", "audioStatus", 'isGif')
    ...
    it "should show home page newArrivals details" do
      ...
      expect(JSON.parse(response.body)['data']['newArrivals']['results'][0].keys).to contain_exactly("id", "title", "language", "level", "slug", "recommended", "editorsPick", "coverImage", "authors", "illustrators", "likesCount", "publisher", "readsCount", "description", "contest", "availableForOfflineMode", "storyDownloaded", "isAudio", "audioStatus", 'isGif')
    ...
    it "should show home page mostRead details" do
      ...
      expect(JSON.parse(response.body)['data']['mostRead']['results'][0].keys).to contain_exactly("id", "title", "language", "level", "slug", "recommended", "editorsPick", "coverImage", "authors", "illustrators", "likesCount", "publisher", "readsCount", "description", "contest", "availableForOfflineMode", "storyDownloaded", "isAudio", "audioStatus", 'isGif')
...
#Need to be changes as per new recommendation algorithm
=begin
