  ...
  list_categories.each do |list_category|
    list_translation = list_category.translation
    list_translation.translated_name = list_translation.name
    list_translation.save!
  end
...
Language.all.each do |lang|
  ...
  Organization.all.each do |org|
    translations = org.translations.first
    translations.translated_name = org.organization_name
    translations.save!
  end

  StoryCategory.all.each do |story|
    translations = story.translations.first
    translations.translated_name = story.name
    translations.save!
  end

  IllustrationCategory.all.each do |illustration|
    translations = illustration.translations.first
    translations.translated_name =illustration.name
    translations.save!
  end

  IllustrationStyle.all.each do |style|
    translations = style.translations.first
    translations.translated_name =style.name
    translations.save!
  end