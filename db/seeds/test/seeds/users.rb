...
create_org_user User.new(first_name: 'Pratham Books', email:'orguser@example.com', password: 'password', password_confirmation:'password')
...
create_confirmed_user User.new(first_name: 'Pratham Books', email:'admin@example.com', password: 'prathambooks', logo: File.open('app/assets/images/publisher_logos/Pratham Books Logo.jpg'))
