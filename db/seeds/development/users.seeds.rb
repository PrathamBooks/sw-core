...
#create_confirmed_user Publisher.new(first_name: 'Pratham Books', email:'admin@example.com',password: 'prathambooks', password_confirmation:'prathambooks', attribution: '© Pratham Books', logo: File.open('app/assets/images/publisher_logos/Pratham Books Logo.jpg'))
