...
ActiveRecord::Schema.define(version: 20180907085542) do
  ...
  create_table "illustrations_downloads", id: false, force: true do |t|
    t.integer "illustration_download_id", null: false
    t.integer "illustration_id",          null: false
  end

  add_index "illustrations_downloads", ["illustration_download_id", "illustration_id"], name: "illustrations_downloads_index", using: :btree
  ...
  create_table "textboxes", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "root_textbox_id"
    t.integer  "textbox_type",                                  default: 0
    t.integer  "background_color",                              default: 100
    t.boolean  "boundary",                                      default: false
  end

  add_index "textboxes", ["page_id", "page_type"], name: "index_textboxes_on_page_id_and_page_type", using: :btree
  add_index "textboxes", ["root_textbox_id"], name: "index_textboxes_on_root_textbox_id", using: :btree

  create_table "translator_stories", force: true do |t|
    t.date    "start_date"
    t.integer "story_id"
  ...
  create_table "users", force: true do |t|
    ...
    t.integer  "story_download_count",                     default: 0
    t.integer  "illustration_download_count",              default: 0
    t.boolean  "first_illustration_download_limit",        default: false
