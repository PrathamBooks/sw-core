Rails.application.routes.draw do
  ...
  scope :v0 do
    ...
    resources 'illustrations', except: [:show] do
      get :autocomplete_user_email, :on => :collection
      get :autocomplete_tag_name, :on => :collection
    end
    # redirecting to new react page
    get '/illustrations/:id', to: redirect('/illustrations/%{id}')
    ...
    get 'stories/:id/story-review', to: 'stories#story_review_new', as: :story_review
    ...
    get 'stories/autocomplete', to: "stories#autocomplete", as: :stories_autocomplete
    get '/unsubscribe', to: "home#unsubscribe_emails", as: :unsubscribe_emails
    post '/update_unsubscribe_reasons', to: "home#update_unsubscribe_reasons", as: :update_unsubscribe_reasons
    ...
    get '/editor/page_editor/:id', to: 'story_editor#page_editor' , as: :set_page_editor
    post '/editor/page_editor/:page_id/textbox/:id', to: 'story_editor#update_textbox', as: :update_textbox
    ...
    get '/editor/story/:id/storycard_crop', to: 'story_editor#storycard_crop', as: :editor_storycard_crop_edit
    post '/editor/story/:id/storycard_crop_save', to: 'story_editor#storycard_crop_save', as: :editor_storycard_crop_save
    put  '/editor/story/:id/storycard_image_upload', to: 'story_editor#storycard_image_upload', as: :editor_storycard_image_upload
    ...
    get '/editor/:id', to: "translations#update_auto_translation", as: :update_auto_translation
    get "/editor/:story_id/relevel", to: "relevels#relevel_story", as: :relevel_story
    get '/editor/page/:id/create_textbox', to: 'story_editor#create_textbox', as: :create_textbox
    delete '/editor/page_editor/page/:page_id/textbox/:id', to: 'story_editor#destroy_textbox', as: :destroy_textbox
    post '/editor/story/:id/translation_feedback', to: 'story_editor#translation_feedback', as: :submit_translation_feedback
    ...
    get '/dashboard/words-added-daily', to: 'dashboard#words_added_daily', as: :words_added_daily
    ...
    #content exchange token routes
    get 'dashboard/content_exchange_tokens', to: 'dashboard#content_exchange_tokens', as: :content_exchange_tokens
    get 'dashboard/content_exchange_token/new', to: 'dashboard#new_content_exchange_token', as: :new_content_exchange_token
    post 'dashboard/content_exchange_token/create', to: 'dashboard#create_content_exchange_token', as: :create_content_exchange_token
    delete 'dashboard/content_exchange_token/:id', to: 'dashboard#delete_content_exchange_token'

    #opds management routes
    get 'dashboard/opds_management', to: 'dashboard#opds_management', as: :opds_management

    get 'dashboard/lists', to: 'dashboard#lists', as: :lists
    get 'dashboard/users_recommended', to: 'dashboard#users_recommended', as: :users_recommended
    ...
    get '/dashboard/bulk_pull_down_stories', to: 'dashboard#bulk_pull_down_stories', as: :bulk_pull_down_stories
    ...
    get '/dashboard/bulk_pull_down_illustrations', to: 'dashboard#bulk_pull_down_illustrations', as: :bulk_pull_down_illustrations
    ...
    get 'dashboard/un_reviewed_stories', to: 'dashboard#un_reviewed_stories', as: :un_reviewed_stories
    ...
    get 'dashboard/translate_stories', to: 'dashboard#translate_stories', as: :translate_stories
    ...
    get 'dashboard/get_tlanguage_stories_new', to: 'dashboard#get_tlanguage_stories_new', as: :get_tlanguage_stories_new
    post 'dashboard/assign_stories_translator', to: 'dashboard#assign_stories_translator', as: :assign_stories_translator
    ...
    #audio_stories
    get '/dashboard/draft_audio_stories', to: 'dashboard#draft_audio_stories', as: :draft_audio_stories
    get '/dashboard/published_audio_stories', to: 'dashboard#published_audio_stories', as: :published_audio_stories
    get '/dashboard/audios_upload_new', to: 'dashboard#audios_upload_new' , as: :audios_upload_new
    get '/dashboard/publish_audio_story', to: 'dashboard#publish_audio_story', as: :publish_audio_story
    post '/dashboard/audios_upload', to: 'dashboard#audios_upload' , as: :audios_upload
    get '/dashboard/get_sls_file', to: 'dashboard#get_sls_file' , as: :get_sls_file
    delete '/dashboard/delete_audio/:id', to: 'dashboard#delete_audio' , as: :delete_audio

    #ban_user
    get '/dashboard/banned_users', to: 'dashboard#banned_users', as: :banned_users
    put '/dashboard/ban_user', to: 'dashboard#ban_user', as: :ban_user
    put '/dashboard/unban_user/:user_id', to: 'dashboard#unban_user', as: :unban_user

    #video_stories
    post '/dashboard/make_video', to: 'dashboard#make_video', as: :make_video
    get '/dashboard/draft_video_stories', to: 'dashboard#draft_video_stories', as: :draft_video_stories
    get '/dashboard/published_video_stories', to: 'dashboard#published_video_stories', as: :published_video_stories
    get '/dashboard/publish_video_story', to: 'dashboard#publish_video_story', as: :publish_video_story
    get '/dashboard/get_video_file', to: 'dashboard#get_video_file' , as: :get_video_file
    delete '/dashboard/delete_video/:id', to: 'dashboard#delete_video' , as: :delete_video
    ...
    get 'translator/un_translated_stories', to: 'profile#un_translated_stories_new', as: :translator_un_translated_stories
    get 'translator/translator_language_stories', to: 'profile#get_translator_language_stories', as: :get_translator_language_stories
    get 'translator/translator_language_stories_new', to: 'profile#get_translator_language_stories_new', as: :get_translator_language_stories_new
    ...
    get '/our_partners', to: 'contents#our_partners' , as: :v0_our_partners
    get '/our_supporters', to: redirect('/our_partners')
    ...
    get '/community_guidelines', to: 'contents#community_guidelines' , as: :v0_community_guidelines
    get '/dos_and_donts', to: redirect('/community_guidelines')
    ...
    get '/attributions', to: 'contents#attributions' , as: :v0_attributions
    ...
    get '/imld', to: 'contents#imld', as: :v0_imld
    get '/imld_faqs', to: 'contents#imld_faqs', as: :v0_imld_faqs
    get '/thank_you', to: 'contents#thank_you', as: :v0_thank_you
  ...
  get '/our_partners', to: 'contents#our_partners' , as: :our_partners
  get '/our_supporters', to: redirect('/our_partners')
  ...
  get '/community_guidelines', to: 'contents#community_guidelines' , as: :community_guidelines
  get '/dos_and_donts', to: redirect('/community_guidelines')
  ...
  get '/attributions', to: 'contents#attributions' , as: :attributions
  ...
  get '/imld', to: 'contents#imld', as: :imld
  get '/imld_faqs', to: 'contents#imld_faqs', as: :imld_faqs
  get '/thank_you', to: 'contents#thank_you', as: :thank_you
  ...
  get '/blog/banners', to: 'blog_posts#banners', as: :banners
  get '/blog/banners/new', to: 'blog_posts#new_banner', as: :new_banner
  post '/blog/banners/create', to: 'blog_posts#create_banner', as: :create_banner
  get '/blog/banners/edit/:id', to: 'blog_posts#edit_banner', as: :edit_banner
  put '/blog/banners/update/:id', to: 'blog_posts#update_banner', as: :update_banner
  delete '/blog/delete_banner/:id', to: 'blog_posts#delete_banner' , as: :delete_banner
  ...
  get '/audios',            to: 'react#index', as: :react_audios
  #robot
  ...
  namespace :api, defaults: {format: 'json'} do
    ...
    namespace :v1 do
      ...
      get '/confirm_story_formats', to: 'search#confirm_story_formats', as: :confirm_story_formats
      get '/confirm_illustration_formats', to: 'search#confirm_illustration_formats', as: :confirm_illustration_formats
      get '/image-bulk-download', to: 'search#image_bulk_download', as: :image_bulk_download
      get '/home', to: 'home#show', as: :home
      get '/home/banners', to: 'home#banners', as: :banners
      get '/home/recommendations', to: 'home#recommendations', as: :recommendations
      get '/home/cards', to: 'home#cards', as: :cards
      ...
      get 'stories/:id/check-translations', to: 'stories#check_translations', as: :story_check_translations
      get '/stories/:id/translate_recommendations', to: 'stories#translate_recommendations', as: :stories_translate_recommendations
      post '/stories/:id/flag', to: 'stories#flag_story', as: :story_flag
      post '/stories/:id/like', to: 'stories#story_like', as: :story_like
      post "/stories/:id/relevel", to: "stories#update_story_level", as: :update_story_level
      ...
      post '/update_consent_flag', to: "home#update_consent_flag", as: :update_consent_flag
      get '/illustrations/:id', to: 'illustrations#show', as: :illustration
      post '/smiley_ratings', to: "stories#smiley_ratings", as: :smiley_ratings
      resources :lists
      resources :albums
      ...
      get '/flash_notice', to: 'home#flash_notice', as: :flash_notice
    end
  end
end
