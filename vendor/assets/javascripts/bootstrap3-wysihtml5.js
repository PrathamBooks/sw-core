!function($, wysi) {
            ...
            return "" +
                "<li class='dropdown wysihtml5-toolbar-fontSize'>" +
                    ...
                    "<ul class='dropdown-menu menu-size'>" +
                        "<li><a data-wysihtml-command='fontSize' data-wysihtml-command-value='normal' tabindex='-1'>Normal</a></li>" +
                        "<li role='presentation' class='divider'></li>" +
                        "<li><a class='largest' data-wysihtml-command='fontSize' data-wysihtml-command-value='largest' tabindex='-1'>Largest</a></li>" +
                        "<li><a class='large' data-wysihtml-command='fontSize' data-wysihtml-command-value='large' tabindex='-1'>Large</a></li>" +
                        "<li><a class='medium' data-wysihtml-command='fontSize' data-wysihtml-command-value='medium' tabindex='-1'>Medium</a></li>" +
                        "<li><a class='small' data-wysihtml-command='fontSize' data-wysihtml-command-value='small' tabindex='-1'>Small</a></li>" +
                        "<li><a class='smallest' data-wysihtml-command='fontSize' data-wysihtml-command-value='smallest' tabindex='-1'>Smallest</li>" +
                    "</ul>" +
                "</li>";
        },
            ...
            return "" +
                "<li class='dropdown wysihtml5-toolbar-color'>" +
                    ...
                    "<ul class='dropdown-menu'>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='black'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='black'>" + locale.colours.black + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='silver'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='silver'>" + locale.colours.silver + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='gray'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='gray'>" + locale.colours.gray + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='maroon'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='maroon'>" + locale.colours.maroon + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='red'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='red'>" + locale.colours.red + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='purple'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='purple'>" + locale.colours.purple + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='green'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='green'>" + locale.colours.green + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='olive'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='olive'>" + locale.colours.olive + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='navy'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='navy'>" + locale.colours.navy + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='blue'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='blue'>" + locale.colours.blue + "</a></li>" +
                        "<li><div class='wysihtml5-colors' data-wysihtml-command-value='orange'></div><a class='wysihtml5-colors-title' data-wysihtml-command='foreColor' data-wysihtml-command-value='orange'>" + locale.colours.orange + "</a></li>" +
                    "</ul>" +
                "</li>";
        },
        ...
        "emphasis": function(locale, options) {
            ...
            return "" +
                "<li class='wysihtml5-toolbar-emphasis'>" +
                    "<div class='btn-group'>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='bold' title='" + locale.emphasis.bold + " (CTRL+B)' tabindex='-1'><i class='glyphicon glyphicon-bold'></i></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='italic' title='" + locale.emphasis.italic + " (CTRL+I)' tabindex='-1'><i class='glyphicon glyphicon-italic'></i></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='underline' title='" + locale.emphasis.underline + " (CTRL+U)' tabindex='-1'><b><u>U</u></b></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='subscript' title='" + locale.emphasis.subscript + " (CTRL+S)' tabindex='-1'><i class='fa fa-subscript'></i></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='superscript' title='" + locale.emphasis.superscript + " (CTRL+P)' tabindex='-1'><span class='fa fa-superscript'></span></a>" +
                    "</div>" +
                "</li>";
        },
        ...
        "textAlign": function(locale, options) {
            ...
            return "" +
                "<li class='wysihtml5-toolbar-textAlign'>" +
                    "<div class='btn-group'>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='justifyLeft' title='" + locale.text.alignLeft + "' tabindex='-1'><i class='glyphicon glyphicon-align-left'></i></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='justifyCenter' title='" + locale.text.alignCenter + "' tabindex='-1'><i class='glyphicon glyphicon-align-center'></i></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='justifyFull' title='" + locale.text.alignJustify + "' tabindex='-1'><i class='glyphicon glyphicon-align-justify'></i></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='justifyRight' title='" + locale.text.alignRight + "' tabindex='-1'><i class='glyphicon glyphicon-align-right'></i></a>" +
                    "</div>" +
                "</li>";
        },
        ...
        "lists": function(locale, options) {
            ...
            return "" +
                "<li class='wysihtml5-toolbar-lists'>" +
                    "<div class='btn-group'>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='insertUnorderedList' title='" + locale.lists.unordered + "' tabindex='-1'><i class='glyphicon glyphicon-list'></i></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='glyphicon glyphicon-th-list'></i></a>" +
                        "<a class='btn " + size + " btn-default' data-wysihtml-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='glyphicon glyphicon-indent-right'></i></a>" +
                        "<a class='btn -" + size + " btn-default' data-wysihtml-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='glyphicon glyphicon-indent-left'></i></a>" +
                    "</div>" +
                "</li>";
        },
        ...
        "blockquote": function(locale, options) {
            ...
            return "" +
                "<li class='wysihtml5-toolbar-blockquote'>" +
                    "<a class='btn " + size + " btn-default' data-wysihtml-command='insertBlockQuote' title='" + locale.text.blockquote + "' tabindex='-1'><i style='font-weight:bold;'>„”</i></a>" +
                "</li>";
        },
    ...
    Wysihtml.prototype = {
        ...
        createToolbar: function(el, options) {
            ...
            toolbar.find("a[data-wysihtml-command='fontSize']").click(function(e) {
        ...
        initHtml: function(toolbar) {
            var changeViewSelector = "[data-wysihtml-action='change_view']";
        ...
        initInsertImage: function(toolbar, culture) {
            ...
            var localInputButton = insertImageModal.find('.bootstrap-wysihtml-insert-image-local');
            var localInputFile = insertImageModal.find('.bootstrap-wysihtml-insert-image-file');
        ...
        initInsertVideo: function(toolbar) {
            var self = this;
            var insertVideoModal = toolbar.find('.bootstrap-wysihtml-insert-video-modal');
            var urlInput = insertVideoModal.find('.bootstrap-wysihtml-insert-video-url');
        ...
        initInsertTable: function(toolbar) {
            var self = this,
                insertTableModal = toolbar.find('.bootstrap-wysihtml-insert-table-modal'),
                rowsInput = insertTableModal.find('.wysihtml-table-rows'),
                colsInput = insertTableModal.find('.wysihtml-table-cols'),
...
(function(wysihtml) {
    ...
    wysihtml.commands.insertVideo = {
        ...
        state: function(composer) {
            ...
            videosInSelection = composer.selection.getNodes(doc, wysihtml.ELEMENT_NODE, function(node) {
    ...
    wysihtml.commands.createTable.exec = function(composer, command, value) {
